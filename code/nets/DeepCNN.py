...
class DeepCNN(torch.nn.Module):
    ...
    def __init__(self, options):
        ...
        self.conv1 = torch.nn.Conv2d(in_channels=1, out_channels=8, kernel_size=3, stride=1,padding=1)  # out: [8 x 28 x 28]
        ...
        self.conv2 = torch.nn.Conv2d(in_channels=8, out_channels=16, kernel_size=3, stride=1,padding=1)  # out: [16 x 14 x 14]
        ...
        self.conv3 = torch.nn.Conv2d(in_channels=16, out_channels=32, kernel_size=3, stride=1,padding=1)  # out: [32 x 7 x 7]
        self.conv3_bn = torch.nn.BatchNorm2d(32)
        self.relu3 = torch.nn.ELU()

        if options.use_batchnorm:
