...
We implemented our neural networks with the PyTorch framework \cite{PyTorch}. This allowed use to reuse various already existing modules for loading the dataset, applying image transformations, assembling the neural network architecture with different kinds of layers and activation functions and hooking established optimizers such as Adam \cite{Adam} into the training procedure.
