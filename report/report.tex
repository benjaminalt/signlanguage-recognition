...
[TODO: The algorithm code \ref{alg:filter_visualization} does not explain, where \texttt{conv\_output} comes from. it was never declared nor returned by a function].
